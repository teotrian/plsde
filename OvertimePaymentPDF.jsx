...
const OvertimePaymentPDF = ({ requests, name }) => (
  <Document>
    <Page size={{ width: 841.89, height: 595.28 }} style={styles.page}>
      <Image src={logo} style={styles.logo} />
      <Text style={styles.header}>Κατάσταση Πληρωμής Υπερωριών</Text>
      ...
      <View style={styles.table}>
        <View style={[styles.row, { fontWeight: 'bold' }]}>
          ...
          <Text style={styles.tableHeader}>Υπερωρίες</Text>
        ...
        {requests.map((req, index) => (
          <View key={req.id} style={styles.row}>
            ...
            <Text style={styles.cell}>{req.number_of_overtimes}</Text>
            <Text style={styles.cell}>{req.compensation} €</Text>
            <Text style={styles.cell}>{req.mtpy} €</Text>
            <Text style={styles.cell}>{req.eisfora} €</Text>
            <Text style={styles.cell}>{req.foros} €</Text>
            <Text style={styles.cell}>{req.payable} €</Text>
...
export default OvertimePaymentPDF;